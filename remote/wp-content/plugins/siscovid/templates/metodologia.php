  ...
  <div class="container-fluid">
    ...
    <div class="row project-methodology-row">
      <div class="col-6 offset-3 offset-1">
        ...
        <img class="animate" src="/wp-content/uploads/banner-temp.png" alt="<?php _e('Banner temporal', 'siscovid')?>">
      </div>
    </div>
    ...
    <div class="row model-row">
      <div class="col-6 offset-3 model-container">
        ...
        <div class="model agents active">
          <!-- <div class="gist-test">
            <script src="https://gist.github.com/elderant/d53368c187bfe385cfa7e64e74b146a3.js"></script>
            <a href="https://github.com/siscovid" target="_blank">CustomLink to github repository</a>
          </div> -->
          ...
          <div class="model-part properties hidden">
          ...
          <div class="model-part environment hidden">
            <h6><?php _e('Ambiente','siscovid');?></h6>
          ...
          <div class="model-part other">
            <h6><?php _e('Supuestos','siscovid');?></h6>
            ...
            <h6><?php _e('Variables de salida','siscovid');?></h6>
          ...
          <!-- page 6 -->
          <div class="model-part references">
