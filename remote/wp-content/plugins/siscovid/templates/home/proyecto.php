<div id="project">
  <div class="container-fluid">
    <div class="row d-flex align-items-center impacto-row">
      <div class="col-xl-5 col-lg-6 col-6 offset-xl-1 p-5 text-container">
      ...
      <div id="vega-map" class="col-xl-5 col-lg-6 col-6 banner-container">
    ...
    <div class="row d-flex align-items-center encuestas-row background-light">
      ...
      <div class="col-xl-5 col-lg-6 col-6 banner-container">
