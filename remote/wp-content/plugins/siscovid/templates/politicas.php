    ...
    <div class="row static-row introduction">
      ...
      <div class="factors-text col-8 fade-in fade-out static-element">
        ...
        <div class="factor-container static-subelement fade-in first-factor">
          <div class="row">
            <div class="col-4 offset-2 d-flex flex-column justify-content-center">
      ...
      <div class="interventions-text col-8 fade-in fade-out static-element">
      ...
      <div class="inf-container col-8 fade-in fade-out static-element">
        ...
        <div class="static-subelement inf-individual fade-out d-flex">
          <div class="static-subelement text-container fade-in slide-left-in col-4 d-flex flex-column justify-content-center">
          ...
          <div class="static-subelement image-container fade-in slide-right-in col-8">
            <img src="/wp-content/uploads/politicas-inf-image1.png" alt="<?php _e('Individual Interventions','siscovid');?>">
          </div>
        </div>
        <div class="static-subelement inf-community fade-in fade-out">
          ...
          <div class="static-subelement bottom-container fade-in d-flex">
            <div class="col-8">
            ...
            <div class="static-subelement highlight pulse message col-4">
      ...
      <div class="inf-effectiveness col-8 static-element fade-in fade-out">
      ...
      <div class="if-vaccines col-8 static-element fade-in fade-out">    
        ...
        <div class="static-subelement fade-in if-main-container d-flex">
          <div class="col-12 vaccines">
            ...
            <div class="row phase-row phase-preclinic-row static-subelement fade-in-slow slide-up-in-slow fade-out-slow slide-up-out-slow">
              <div class="vaccine-text col-6 static-subelement fade-in-slow slide-left-in-slow fade-out-slow slide-left-out-slow d-flex align-items-center">
              ...
              <div class="vaccine-image col-6 static-subelement fade-in-slow slide-right-in-slow fade-out-slow slide-right-out-slow text-center d-flex justify-content-center align-items-center">
      ...
      <div class="interventions-used col-8 static-element fade-in fade-out text-center">
        <h3 class="title">
      ...
      <div class="interventions-opinion col-8 fade-in fade-out static-element">
        ...
        <div class="row">
          ...
          <div class="col-6 d-flex justify-content-center flex-column text-column">
      ...
      <div class="interventions-maxims col-8 fade-in fade-out static-element">
        <div class="row">
          <div class="col-12">
            <h3 class="title">
      ...
      <div class="models-intro col-8 fade-in fade-out static-element">
        <div class="row">
          <div class="col-12">
        ...
        <div class="row">
          ...
          <div class="col-6 image-column text-center">
      ...
      <div class="model-population col-8 fade-in fade-out static-element">
        <div class="row">
          <div class="col-12">
        ...
        <div class="static-subelement fade-in fade-out model-description text-center">
          <div class="row">
            ...
            <div class="col-6 text-column d-flex flex-column justify-content-center">
        ...
        <div class="static-subelement fade-in fade-out slide-left-out model-results1 text-center">
          <div class="row text-row">
            <div class="col-12">
        ...
        <div class="static-subelement fade-in slide-right-in model-results2 text-center">
          <div class="row image-row">
            <div class="col-12">
      ...
      <div class="model-agent col-8 fade-in fade-out static-element">
        <div class="row">
          <div class="col-12">
            <h3 class="background-title d-flex aling-items-start justify-content-end text-center">
        ...
        <div class="static-subelement fade-in model-results">
          <div class="row text-row">
            <div class="col-12">
      ...
      <div class="closing-text col-8 fade-in fade-out static-element last-element">
        <div class="row">
          <div class="col-12">
            <h3 class="title">
